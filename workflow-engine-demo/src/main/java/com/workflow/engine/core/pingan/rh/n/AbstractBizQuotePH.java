 ...
 */
public abstract class AbstractBizQuotePH extends AbstractParamsHandler implements ILogger {
    ...
    protected ParamGeneratorConfig stepNeededParamsConfig() {
        return ParamGeneratorUtil.configParamScheme(
                ...
                ParamGeneratorUtil.schemeParam("bizInfo.isNeedRuleCheck")
                        .chooseStrategy(StrategyType.FIXED)
                        .configStrategyNeedParams("false"),
                ParamGeneratorUtil.schemeParam("bizConfig.pkgName")
                        .chooseStrategy(StrategyType.FIXED)
                        .configStrategyNeedParams("optional"),
                ParamGeneratorUtil.schemeParam("bizInfo.beginDate")
                        .chooseStrategy(StrategyType.CONTEXT)
                        .configStrategyNeedParams("bizBeginDate", ""),
                ParamGeneratorUtil.schemeParam("forceInfo.beginDate")
                        .chooseStrategy(StrategyType.CONTEXT)
                        .configStrategyNeedParams("forceBeginDate", ""),
                ParamGeneratorUtil.schemeParam("bizConfig.inputAmount")
                        .chooseStrategy(StrategyType.CONTEXT)
                        .configStrategyNeedParams("inputAmount", "")
        );
    }

    @Override
    public Map<String, String> generateParams(Map<String, Object> context, Object... others) throws Exception {
        Map<String, String> requestParams = super.generateParams(context, null);
