...
import com.workflow.engine.expression.Evaluable;
import com.workflow.engine.expression.Evaluator;
import com.workflow.engine.expression.IllegalExpressionException;
import com.workflow.engine.expression.annotation.OperatorReload;
    ...
    private Method getOperator(Operator op, Object obj) {
        ...
        if (!evalMethod.containsKey(ck)) {
            ...
            for (Method om : obj.getClass().getMethods()) {
                OperatorReload anno = om.getAnnotation(OperatorReload.class);
